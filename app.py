...
def get_speech_from_text():
    ...
    try:
        ...
        text = "In a team of 4, I participated in HackDartmouth and served as my team’s designer. With a chrome extension and web app, jobarchi.tech was created to help manage job applications and interview prep."
